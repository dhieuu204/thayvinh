          ...
          {categories.map((item) => (
            <motion.div key={item._id} variants={staggerItem}>
              <Link
                ...
                className="bg-[#fbfbfd] rounded-[24px] overflow-hidden hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all duration-500 cursor-pointer group flex flex-col h-[280px] block"
              >
